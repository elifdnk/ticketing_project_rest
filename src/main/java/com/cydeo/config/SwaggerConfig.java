...
@Configuration
@OpenAPIDefinition
public class SwaggerConfig { //create the swagger documentation file for app, including Auth2 security structure.
    ...
    private OAuthFlows createOAuthFlows() {
        ...
        return new OAuthFlows()
                .authorizationCode(flow); //describe what kind of  grant type.
    }
